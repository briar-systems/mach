...
### Added
- Complete documentation refactor with improved structure and clarity

### Changed
- Updated README for improved clarity and consistency in language description
- Refined getting started guide for better completeness

### Fixed
- Removed legacy constants for backward compatibility in comptime_get_constant
