...
- Dependency rollback clears index entries through Git plumbing before restoring exact staged records, so an unstaged `.gitmodules` restoration cannot block rollback.
