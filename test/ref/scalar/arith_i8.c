...
uint64_t checksum(uint64_t seed) {
    ...
    h = mix_i8(h, as_i8(n));
    h = mix_i8(h, as_i8((uint8_t)(UINT8_C(0) - n)));
    h = mix_i8(h, as_i8((uint8_t)(UINT8_C(0) - s)));
    h = mix_i8(h, as_i8((uint8_t)(UINT8_C(127) + a)));
    h = mix_i8(h, as_i8((uint8_t)(UINT8_C(128) - a)));
    h = mix_i8(h, as_i8((uint8_t)(UINT8_C(255) + a)));
    h = mix_i8(h, as_i8((uint8_t)(a + b)));
    h = mix_i8(h, as_i8((uint8_t)(a - b)));
    h = mix_i8(h, as_i8((uint8_t)(b - a)));
    return h;
}
