...
static inline uint8_t shr8(uint8_t v, uint64_t n) { return n >= 8u ? (uint8_t)0 : (uint8_t)(v >> n); }
...
uint64_t checksum(uint64_t seed) {
    ...
    h = mix_u8(h, shr8(b, 9));
    h = mix_u8(h, shl8(c, 9));
    h = mix_u8(h, shl8(a, 16));
    h = mix_u8(h, shr8(a, 16));
    h = mix_u8(h, shr8(b, 16));
    h = mix_u8(h, shl8(c, 16));
    h = mix_u8(h, shl8(a, 23));
    h = mix_u8(h, shr8(a, 23));
    h = mix_u8(h, shr8(b, 23));
    h = mix_u8(h, shl8(c, 23));
    h = mix_u8(h, shl8(a, 255));
    h = mix_u8(h, shr8(a, 255));
    h = mix_u8(h, shr8(b, 255));
    h = mix_u8(h, shl8(c, 255));
    h = mix_u8(h, shl8(a, 33));
    h = mix_u8(h, shr8(a, 33));
    h = mix_u8(h, shr8(b, 33));
    h = mix_u8(h, shl8(c, 33));
