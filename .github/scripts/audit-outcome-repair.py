...
baseline = "2edcd6115cec041c9e47ad4a07789f0f80403fa1"
...
profile = "debug"
compiler = a
test("fatal-parity-diagnostic", "mach.lang.editor.parse:driver_and_editor_share_one_parse_outcome", child=5)
check_source()
