...
| catalog | defined | members | enters | today | class |
| --- | --- | --- | --- | --- | --- |
| `x64.Opcode`, `arm64.Opcode`, `riscv.Opcode`, `mos6502.Opcode` | `target/isa/x64.mach:54`, `arm64.mach:82`, `riscv.mach:97`, `mos6502.mach:40` | 135, 31, 18, 6 | internal (selector) | encoder fallthrough `encode.opcode_failure` (above); `mos6502/encode.mach:367` answers a static "not yet implemented" text (the target has no encoder) | internal; mos6502 unsupported |
