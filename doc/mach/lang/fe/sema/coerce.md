...
Identity-equality predicate with one structural exception: a
[`TYPE_FUN`](../../type.md#typekind) `from` matches a `TYPE_FUN` `to`
iff [`type.type_equals_signatures`](../../type.md#type_equals_signatures)
holds. This exists because function types bypass the
[`TypeInterner`](../../type.md#typeinterner)'s dedup
([`type.intern_function`](../../type.md#intern_function) appends
fresh), so two structurally-equal `TYPE_FUN`s can have different
[`TypeId`](../../type.md#typeid)s.
